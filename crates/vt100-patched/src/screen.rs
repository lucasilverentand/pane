...
impl Screen {
    ...
    /// Returns the current window title set by the terminal (OSC 0/2).
    #[must_use]
    pub fn title(&self) -> &str {
        &self.title
    }

    /// Sets the window title (called from the OSC handler).
    pub(crate) fn set_title(&mut self, title: &[u8]) {
    ...
    pub(crate) fn sgr(
        ...
        loop {
            match next_param!() {
                ...
                // SGR 4:x sub-parameters for underline styles
                [4, 0] => self.attrs.set_underline_style(crate::attrs::UnderlineStyle::None),
                [4, 1] => self.attrs.set_underline_style(crate::attrs::UnderlineStyle::Single),
                [4, 2] => self.attrs.set_underline_style(crate::attrs::UnderlineStyle::Double),
                [4, 3] => self.attrs.set_underline_style(crate::attrs::UnderlineStyle::Curly),
                [4, 4] => self.attrs.set_underline_style(crate::attrs::UnderlineStyle::Dotted),
                [4, 5] => self.attrs.set_underline_style(crate::attrs::UnderlineStyle::Dashed),
                [5] => self.attrs.set_blink(true),
                [6] => self.attrs.set_blink(true),
                [7] => self.attrs.set_inverse(true),
                [9] => self.attrs.set_strikethrough(true),
                [21] => self.attrs.set_underline_style(crate::attrs::UnderlineStyle::Double),
